...
void AProjectPlayerController::SetupInputComponent()
{
	...
	InputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AProjectPlayerController::OnTouchPressed);
	InputComponent->BindTouch(EInputEvent::IE_Released, this, &AProjectPlayerController::OnTouchReleased);
...
void AProjectPlayerController::OnTouchPressed(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	bIsTouch = true;
	OnSetDestinationPressed();
}

void AProjectPlayerController::OnTouchReleased(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	bIsTouch = false;
